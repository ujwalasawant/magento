...
class Magehit_Sociallogin_Model_Facebook_Client
{
    const REDIRECT_URI_ROUTE = 'mhsociallogin/facebook/connect';

    const XML_PATH_ENABLED = 'magehit/magehit_sociallogin_facebook/enabled';
    const XML_PATH_CLIENT_ID = 'magehit/magehit_sociallogin_facebook/client_id';
    const XML_PATH_CLIENT_SECRET = 'magehit/magehit_sociallogin_facebook/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Magehit_Sociallogin_FacebookOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('sociallogin')
...
class Magehit_Sociallogin_FacebookOAuthException extends Exception
{}