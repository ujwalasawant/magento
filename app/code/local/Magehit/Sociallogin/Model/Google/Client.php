<?php
class Magehit_Sociallogin_Model_Google_Client

{

    const REDIRECT_URI_ROUTE = 'mhsociallogin/google/connect';



    const XML_PATH_ENABLED = 'magehit/magehit_sociallogin_google/enabled';

    const XML_PATH_CLIENT_ID = 'magehit/magehit_sociallogin_google/client_id';

    const XML_PATH_CLIENT_SECRET = 'magehit/magehit_sociallogin_google/client_secret';
...

    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Magehit_Sociallogin_GoogleOAuthException($message);
...
class Magehit_Sociallogin_GoogleOAuthException extends Exception
