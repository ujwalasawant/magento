...
class Magehit_Sociallogin_TwitterController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        $this->referer = Mage::getUrl('mhsociallogin/account/twitter');  
    ...
    protected function _connectCallback() {
        ...
        Mage::getSingleton('core/session')->addSuccess(
            $this->__('Your Twitter account is now connected to your new user account at our store. You can login next time by the Twitter SocialLogin button.')
        );        
