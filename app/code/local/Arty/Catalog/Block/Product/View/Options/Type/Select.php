 ...
 * Time: 3:40 PM
 */
class Arty_Catalog_Block_Product_View_Options_Type_Select extends Mage_Catalog_Block_Product_View_Options_Type_Select
{
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            $select = $this->getLayout()->createBlock('core/html_select')
                ->setData(array(
                    ...
                    'class' => $require.' product-custom-option gender'
                ));
            if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN) {
                ...
                $select->setName('options['.$_option->getid().'][]');
                $select->setClass('multiselect'.$require.'product-custom-option gender');
            }
