<?php
/**
 * Magento SecuredCheckout Edition
 *
 * NOTICE OF LICENSE
 *
 * This source file is subject to the Magento SecuredCheckout Edition License
 ...
 */
abstract class Magecheckout_SecuredCheckout_Model_Resource_Sales_Abstract extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     ...
     *
     * @param Mage_Customer_Model_Attribute $attribute
     * @return Magecheckout_SecuredCheckout_Model_Resource_Sales_Abstract
     */
     ...
     *
     * @param Magecheckout_SecuredCheckout_Model_Sales_Abstract $sales
     * @return bool
     */
    public function isEntityExists(Magecheckout_SecuredCheckout_Model_Sales_Abstract $sales)
    {
        if (!$sales->getId()) {
            return false;
        }
