...
class Webskills_Shippingrestriction_IndexController extends Mage_Core_Controller_Front_Action{
	...
	public function FrontAction() 
	{
		...
		{
			echo '<span style="color:#E84100">Congratulations!Shipping is Available for your location</span>';
		}
		else
		{
			echo '<span style="color:#5A9800">Oops!Shipping is not available for your location</span>';
		}	
